...
type repositoryAuthAdmin struct {
	client postgresql.ClientPostgres
	logger logging.Logger
}

func NewAuthorization(client postgresql.ClientPostgres, logger logging.Logger) *repositoryAuthAdmin {
	return &repositoryAuthAdmin{
		client: client,
		logger: logger,
	}
}

func (r *repositoryAuthAdmin) CreateAdmin(ctx context.Context) (int, error) {
...
func (r *repositoryAuthAdmin) GetAdmin(ctx context.Context, username, password string) error {
